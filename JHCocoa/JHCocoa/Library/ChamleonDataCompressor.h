...
// This is a helper class used by ChamleonHTTPRequest to handle deflating (compressing) data in memory and on disk
...
@interface ChamleonDataCompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
