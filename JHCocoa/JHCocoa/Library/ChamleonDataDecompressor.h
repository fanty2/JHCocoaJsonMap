...
// This is a helper class used by ChamleonHTTPRequest to handle inflating (decompressing) data in memory and on disk
...
@interface ChamleonDataDecompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
